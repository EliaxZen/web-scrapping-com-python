...
def extract_page_data(session, page):
    url = f'https://www.creditoreal.com.br/alugueis?page={page}'
    try:
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        futures = {executor.submit(extract_page_data, session, page): page for page in range(1, 426)}
    ...
    df_imovel.to_excel(r'C:\Users\galva\OneDrive\Documentos\GitHub\web-scrapping-com-python\base_de_dados_excel\credito_real_data_base\credito_real_aluguel_06_2024.xlsx', index=False)
